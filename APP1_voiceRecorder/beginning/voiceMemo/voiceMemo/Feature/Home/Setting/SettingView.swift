...
private struct TotalTabMoveView: View {
    ...
    fileprivate var body: some View {
        VStack {
            ...
            TabMoveView(
                title: "To do List") {
                    homeViewModel.changeSelectedTap(.todoList)
                }
            
            TabMoveView(
                title: "메모장") {
                    homeViewModel.changeSelectedTap(.memo)
                }
            
            TabMoveView(
                title: "음성 메모") {
                    homeViewModel.changeSelectedTap(.voiceRecorder)
                }
            
            TabMoveView(
                title: "타이머") {
                    homeViewModel.changeSelectedTap(.timer)
                }
